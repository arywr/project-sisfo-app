...
<div class="container-fluid">
    ...
    <div class="d-sm-flex justify-content-between main-heading mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800 main-heading-title font-weight-500">Form Tambah Data Guru</h1>
    ...
    <div class="row" style="margin-left:0;margin-right:0;">
        <div class="card shadow w-100 mb-4 px-md-3 py-md-3">
            <div class="card-body">
                <div class="w-100">
                    <form action="<?= base_url('/Guru/SaveGuru'); ?>" method="post">
                        <?= csrf_field(); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control <?= ($validation->hasError('alamat')) ? 'is-invalid' : ''; ?>" id="alamat" rows="3" name="alamat" value="<?= old('alamat'); ?>"></textarea>
                        <div class="invalid-feedback">
